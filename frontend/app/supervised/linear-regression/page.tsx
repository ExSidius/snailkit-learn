...
import { generateLinearData } from "@/lib/math";

export default function Page() {
  const data = generateLinearData(50, 1.3, 4, 5, 42);
  ...
  return (
    <div className="mx-auto w-full max-w-4xl px-8 sm:px-16 lg:px-32">
      ...
      <p className="mt-4">
        ...
        solved extremely loosely. He solved it with "The Method of Least Squares".
      </p>
      ...
      {/* TODO: more gauss legendre beefing history */}
      <p className="mt-4">
